...
mcp_in_config[13] = {"none", "none","none", "none",   0, 0, 0};
mcp_in_config[14] = {"light_korytarz_wlacznik", "Korytarz",                      "light", "binary_sensor",1, 1, 8};
mcp_in_config[15] = {"none", "none",         "none", "none",   0, 0, 0};
mcp_in_config[16] = {"light_schody_pietro_wlacznik", "Schody Piętro",            "light", "binary_sensor",1, 1, 9};
mcp_in_config[17] = {"none", "none",         "none", "none",   0, 0, 0};
...
mcp_in_config[25] = {"light_salon_wneka_wlacznik", "Salon Wnęka",               "light", "binary_sensor",   1, 1, 15};
mcp_in_config[26] = {"light_lazienka_parter_wlacznik", "Łazienka Parter",       "light", "binary_sensor",   1, 1, 16};
mcp_in_config[27] = {"none", "none",         "none", "none",   0, 0, 0};
mcp_in_config[28] = {"light_kuchnia_glowne_wlacznik", "Kuchnia Głowne",         "light", "binary_sensor",   1, 1, 17};
mcp_in_config[29] = {"none", "none",         "none", "none",   0, 0, 0};
mcp_in_config[30] = {"light_kuchnia_szafki_wlacznik", "Kuchnia Pod Szafkami",   "light", "binary_sensor",   1, 1, 18};
mcp_in_config[31] = {"none", "none",         "none", "none",   0, 0, 0};
mcp_in_config[32] = {"light_kuchnia_okap_wlacznik", "Kuchnia Okap",             "light", "binary_sensor",   1, 1, 19};
mcp_in_config[33] = {"none", "none",         "none", "none",   0, 0, 0};
mcp_in_config[34] = {"light_spizarnia_wlacznik", "Spirzarnia",                  "light", "binary_sensor",   1, 1, 20};
mcp_in_config[35] = {"none", "none",         "none", "none",   0, 0, 0};
mcp_in_config[36] = {"light_garaz_swiatlo_wlacznik", "Garaz Przy Bramie",       "light", "binary_sensor",   1, 1, 21};
mcp_in_config[37] = {"light_garaz_kom_wlacznik", "Garaz Przy Kuchni",           "light", "binary_sensor",   1, 1, 22};
mcp_in_config[38] = {"light_kotlownia_wlacznik", "Kotlownia",                   "light", "binary_sensor",   1, 1, 23};
mcp_in_config[39] = {"none", "none",         "none", "none",   0, 0, 0};
mcp_in_config[40] = {"light_piwnica_wlacznik", "Piwnica 1",                     "light", "binary_sensor",   1, 1, 24};
mcp_in_config[41] = {"light_piwnica_wlacznik2", "Piwnica_2",                    "light", "binary_sensor",   1, 1, 25};
mcp_in_config[42] = {"none", "none",         "none", "none",   0, 0, 25};
mcp_in_config[43] = {"none", "none",         "none", "none",   0, 0, 26};
mcp_in_config[44] = {"none", "none",         "none", "none",   0, 0, 27};
mcp_in_config[45] = {"none", "none",         "none", "none",   0, 0, 28};
mcp_in_config[46] = {"none", "none",         "none", "none",   0, 0, 27};
mcp_in_config[47] = {"none", "none",         "none", "none",   0, 0, 28};
mcp_in_config[48] = {"light_zmierzchowka_czujnik2", "Zmierzchowka",             "light", "binary_sensor",   1, 0, 30};
mcp_in_config[49] = {"switch_odkurzacz_centralny", "Odkurzacz Centralny",       "plug",  "binary_sensor",   1, 1, 59};
// mcp_in_config[50] = {"none", "none",         "none", "none",   0, 0, 33};
// mcp_in_config[51] = {"none", "none",         "none", "none",   0, 0, 34};
// mcp_in_config[52] = {"none", "none",         "none", "none",   0, 0, 35};
// mcp_in_config[53] = {"none", "none",         "none", "none",   0, 0, 36};
// mcp_in_config[54] = {"none", "none",         "none", "none",   0, 0, 37};
// mcp_in_config[56] = {"none", "none",         "none", "none",   0, 0, 38};
// mcp_in_config[57] = {"none", "none",         "none", "none",   0, 0, 39};
// mcp_in_config[58] = {"none", "none",         "none", "none",   0, 0, 40};
// mcp_in_config[59] = {"none", "none",         "none", "none",   0, 0, 41};
// mcp_in_config[60] = {"none", "none",         "none", "none",   0, 0, 42};
// mcp_in_config[61] = {"none", "none",         "none", "none",   0, 0, 43};
// mcp_in_config[62] = {"none", "none",         "none", "none",   0, 0, 44};
// mcp_in_config[63] = {"none", "none",         "none", "none",   0, 0, 45};
