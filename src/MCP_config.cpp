...
mcp_in_config[30] = {"light_zmierzchowka_czujnik2", "Zmierzchowka",         "light",   0, 0, 30};
...
mcp_out_config[84] = {"bramka_glowna", "Elektrozaczep Bramka Main",                                 "lock", "none",       0, 1, 0, 0};
mcp_out_config[85] = {"bramka_kojec", "Elektrozaczep Kojec na Śmieci",                              "lock", "none",       0, 1, 0, 0};
