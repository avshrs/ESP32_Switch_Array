...
{
mcp_in_config[0] = {"light_dzienny_wlacznik", "Pokój Dzienny",              "light",   1, 1, 0};
mcp_in_config[1] = {"light_dzieciakow_wlacznik", "Pokój Dzieciaków",        "light",   1, 1, 1};
mcp_in_config[2] = {"light_goscinny_wlacznik", "Pokój Gościnny",            "light",   1, 1, 2};
mcp_in_config[3] = {"light_sypialnia1_wlacznik", "Sypialnia male",          "light",   1, 1, 3};
mcp_in_config[4] = {"light_sypialnia2_wlacznik", "Sypialnia duże",          "light",   1, 1, 4};
mcp_in_config[5] = {"light_garderoba_wlacznik", "Garderoba",                "light",   1, 1, 5};
mcp_in_config[6] = {"light_lazienka_pietro_wlacznik", "Łazienka Piętro",    "light",   1, 1, 6};
mcp_in_config[7] = {"light_srtych_wlacznik", "Strych",                      "light",   1, 1, 7};
mcp_in_config[8] = {"light_korytarz_wlacznik", "Korytarz",                  "light",   1, 1, 8};
mcp_in_config[9] = {"light_schody_pietro_wlacznik", "Schody Piętro",        "light",   1, 1, 9};
mcp_in_config[10] = {"light_schody_parter_wlacznik", "Schody Parter",       "light",   1, 1, 10};
mcp_in_config[11] = {"light_wiatrolap_wlacznik", "Wiatrołap",               "light",   1, 1, 11};
mcp_in_config[12] = {"light_salon_kom1_wlacznik", "Salon Komunikacyjne małe",    "light",   1, 1, 12};
mcp_in_config[13] = {"light_salon_kom2_wlacznik", "Salon Komunikacyjne duże",    "light",   1, 1, 13};
mcp_in_config[14] = {"light_salon_glowne_wlacznik", "Salon Główne",         "light",   1, 1, 14};
mcp_in_config[15] = {"light_salon_wneka_wlacznik", "Salon Wnęka",           "light",   1, 1, 15};
mcp_in_config[16] = {"light_lazienka_parter_wlacznik", "Łazienka Parter",   "light",   1, 1, 16};
mcp_in_config[17] = {"light_kuchnia_glowne_wlacznik", "Kuchnia Głowne",     "light",   1, 1, 17};
mcp_in_config[18] = {"light_kuchnia_szafki_wlacznik", "Kuchnia Pod Szafkami",        "light",   1, 1, 18};
mcp_in_config[19] = {"light_kuchnia_okap_wlacznik", "Kuchnia Okap",         "light",   1, 1, 19};
mcp_in_config[20] = {"light_spizarnia_wlacznik", "Spirzarnia",              "light",   1, 1, 20};
mcp_in_config[21] = {"light_garaz_swiatlo_wlacznik", "Garaz Przy Bramie",   "light",   1, 1, 21};
mcp_in_config[22] = {"light_garaz_kom_wlacznik", "Garaz Przy Kuchni",       "light",   1, 1, 22};
mcp_in_config[23] = {"light_kotlownia_wlacznik", "Kotlownia",               "light",   1, 1, 23};
mcp_in_config[24] = {"light_piwnica_wlacznik", "Piwnica 1",                 "light",   1, 1, 24};
mcp_in_config[25] = {"none", "none",         "none",   0, 0, 25};
mcp_in_config[26] = {"none", "none",         "none",   0, 0, 26};
mcp_in_config[27] = {"none", "none",         "none",   0, 0, 27};
mcp_in_config[28] = {"none", "none",         "none",   0, 0, 28};
mcp_in_config[29] = {"light_piwnica_wlacznik2", "Piwnica_2",                "light",   1, 1, 25};
mcp_in_config[30] = {"none", "Zmierzchowka",                                "light",   0, 0, 30};
mcp_in_config[31] = {"light_zmierzchowka_czujnik", "Zmierzchowka",          "light",   1, 1, 31};
mcp_in_config[32] = {"switch_odkurzacz_centralny", "Odkurzacz Centralny",   "plug",    1, 1, 59};
// mcp_in_config[33] = {"none", "none",         "none",   0, 0, 33};
// mcp_in_config[34] = {"none", "none",         "none",   0, 0, 34};
// mcp_in_config[35] = {"none", "none",         "none",   0, 0, 35};
// mcp_in_config[36] = {"none", "none",         "none",   0, 0, 36};
// mcp_in_config[37] = {"none", "none",         "none",   0, 0, 37};
// mcp_in_config[38] = {"none", "none",         "none",   0, 0, 38};
// mcp_in_config[39] = {"none", "none",         "none",   0, 0, 39};
// mcp_in_config[40] = {"none", "none",         "none",   0, 0, 40};
// mcp_in_config[41] = {"none", "none",         "none",   0, 0, 41};
// mcp_in_config[42] = {"none", "none",         "none",   0, 0, 42};
// mcp_in_config[43] = {"none", "none",         "none",   0, 0, 43};
// mcp_in_config[44] = {"none", "none",         "none",   0, 0, 44};
// mcp_in_config[45] = {"none", "none",         "none",   0, 0, 45};
// mcp_in_config[46] = {"none", "none",         "none",   0, 0, 46};
// mcp_in_config[47] = {"none", "none",         "none",   0, 0, 47};
// mcp_in_config[48] = {"none", "none",         "none",   0, 0, 48};
// mcp_in_config[49] = {"none", "none",         "none",   0, 0, 49};
// mcp_in_config[50] = {"none", "none",         "none",   0, 0, 50};
// mcp_in_config[51] = {"none", "none",         "none",   0, 0, 51};
// mcp_in_config[52] = {"none", "none",         "none",   0, 0, 52};
// mcp_in_config[53] = {"none", "none",         "none",   0, 0, 53};
// mcp_in_config[54] = {"none", "none",         "none",   0, 0, 54};
// mcp_in_config[55] = {"none", "none",         "none",   0, 0, 55};
// mcp_in_config[56] = {"none", "none",         "none",   0, 0, 56};
// mcp_in_config[57] = {"none", "none",         "none",   0, 0, 57};
// mcp_in_config[58] = {"none", "none",         "none",   0, 0, 58};
// mcp_in_config[59] = {"none", "none",         "none",   0, 0, 59};
// mcp_in_config[60] = {"none", "none",         "none",   0, 0, 60};
// mcp_in_config[61] = {"none", "none",         "none",   0, 0, 61};
// mcp_in_config[62] = {"none", "none",         "none",   0, 0, 62};
// mcp_in_config[63] = {"none", "none",         "none",   0, 0, 63};
...
mcp_out_config[25] = {"none", "Piwnica_2",                          "light",  "light",     0, 1, 0, 1};
mcp_out_config[26] = {"none", "none",        "none", "none",   0, 1, 0, 0};
mcp_out_config[27] = {"none", "none",        "none", "none",   0, 1, 0, 0};
mcp_out_config[28] = {"light_podbitka_tyl2_mcp", "Podbitka Tył dodatkowe",          "light",  "light",      1, 1, 0, 0};
mcp_out_config[29] = {"light_podbitka_przod2_mcp", "Podbitka Przód dodatkowe",      "light",  "light",      1, 1, 0, 0};
mcp_out_config[30] = {"light_podbitka_tyl1_mcp", "Podbitka Tył duże",               "light",  "light",      1, 1, 0, 0};
mcp_out_config[31] = {"light_podbitka_przod1_mcp", "podbitka Przód duże",           "light",  "light",      1, 1, 0, 0};
...
mcp_out_config[49] = {"outlet_kuchnia_nad_blat_mcp", "Kuchnia Zmywarka",            "outlet",  "switch",   1, 1, 0, 0};
...
mcp_out_config[76] = {"zraszacz_sekcja_1", "Zraszacz Zachodnia",                                    "switch", "switch",   0, 1, 0, 0};
mcp_out_config[77] = {"zraszacz_sekcja_2", "Kroplownica Zachód",                                    "switch", "switch",   0, 1, 0, 0};
mcp_out_config[78] = {"zraszacz_sekcja_3", "Zraszacz Przy Bramce ",                                 "switch", "switch",   0, 1, 0, 0};
mcp_out_config[79] = {"zraszacz_sekcja_4", "Kroplownica Wejście ",                                  "switch", "switch",   0, 1, 0, 0};
mcp_out_config[80] = {"zraszacz_sekcja_5", "Zraszacz Połódnie",                                     "switch", "switch",   0, 1, 0, 0};
mcp_out_config[81] = {"zraszacz_sekcja_6", "Kroplownica Połódnie",                                  "switch", "switch",   0, 1, 0, 0};
...
mcp_out_config[84] = {"none", "Elektrozaczep Bramka Main",                                          "switch", "switch",   0, 1, 0, 0};
mcp_out_config[85] = {"none", "Elektrozaczep Kojec na Śmieci",                                      "switch", "switch",   0, 1, 0, 0};
