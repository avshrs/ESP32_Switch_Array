...
class MCP {
    private:
        uint8_t mcpAddress;
        uint8_t mcp_bus;
        uint8_t mcp_gpioa_type;
        uint8_t mcp_gpioa_pull;
        uint8_t mcp_gpiob_type;
        uint8_t mcp_gpiob_pull;
    ...
    public:
        void MCP_Init(uint8_t bus, uint8_t MCPADDRSS, uint8_t GIPOA_TYPE, uint8_t GIPOA_PULL, uint8_t GIPOB_TYPE, uint8_t GIPOB_PULL);
